  ...
  render() {
    return (
      <div className="app-container">
        ...
        ?
        <BeamSelector protoFrame={this.state.protoFrame} frame={this.state.frame} handleBeamChange={this.handleBeamChange} getCalcReport={this.getCalcReport} endRail={this.state.checkboxes.endRail} noFlp={this.state.checkboxes.noFlp}/>
        :
        <div></div>
      }
